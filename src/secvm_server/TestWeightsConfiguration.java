...
public class TestWeightsConfiguration extends WeightsConfiguration {
	...
	public TestWeightsConfiguration(int svmId, int iteration, int numBins, float[] diceRollProbabilities,
			Features[] features, List<Integer> testOutcomesDiceRoll, List<Float> weightsToUseForTesting) {
