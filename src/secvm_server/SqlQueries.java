...
public enum SqlQueries {
	...
	GET_TEST_CONFIGURATIONS(
			...
			"FROM svm, weight_vector, svm_uses_feature_vector feature_vector\n" + 
			"WHERE svm.train_enabled = 1 AND svm.svm_id = weight_vector.svm_id " +
			"	AND svm.svm_id = feature_vector.svm_id " +
			"	AND (weight_vector.num_participants >= svm.min_number_train_participants OR weight_vector.iteration = 0)\n" + 
			"ORDER BY svm.svm_id, weight_vector.iteration DESC");
